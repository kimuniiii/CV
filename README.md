...
正社員の方がいなかった為、フロントエンドエンジニアのリードエンジニアとしての役割を抜擢されました。エンジニアリングだけでなく、採用面接などにも同席し、プロジェクトの成功に尽力しました。そして納期が相当厳しい状況下において、実際に最初に決めた納期通りにサービスをリリースさせることに成功しました。リリース日が遅れなかったことによって、予定通りに「PMFを達成するかどうか」の仮説検証を進めることが出来ました。リリース後は「CVRを向上させること」を最重要KPIに添えて、様々な内部品質の改善業務を行っていきました。効果的な施策を打てるようにマーケティング測定ツールを迅速に導入したり、最適な予約導線の設計・実装を行いました。予約導線の改修をしたことによって、実際にサイトを離脱せずに予約をするユーザーを増やすことに成功しました。CVRが向上したので、次はGMVXXX万円を達成させるために、クーポンの新機能の実装を行いました。これも速やかに開発を進めたことによって、予定通りにリリースすることに成功し、そのあとビジネスサイドの方にご尽力いただき、GMVXXX万円の目標を達成することに成功しました。
