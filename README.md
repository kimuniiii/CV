...
HTML5 | CSS3 | JavaScript | jQuery | TypeScript | React | React Native | Next.js Pages Router | Next.js App Router | Radix UI | shadcn/ui | zustand | immer | Recoil | Redux | Redux Toolkit | React Hook Form | zod | Apollo Client | GraphQL | React Query | SWR | Swagger | aspida | Orval | Tailwind CSS | styled-components | emotion | Lodash | rfdc | date-fns | dayjs | Moment | Jest | Vitest | React Testing Library | Cypress | PlayWright | ESLint | Prettier | Husky | lint-staged | Renovate | Web Components | Lit Element | Storybook
...
MySQL | PostgreSQL | PlanetScale | Vercel | Heroku | GitHub | GitHub Pages | GitHub Packages | GitHub Actions | Docker | Docker Compose | Sentry | Datadog | nginx | Apache | AWS ECS | AWS Amplify | Google Cloud | Auth0 | Hasura | Firebase | Supabase | Fly.io | microCMS
...
Webフロントエンド領域を中心に、  
React / TypeScript / Next.js を用いた新規プロダクト開発（0→1） を得意とするエンジニアです。

これまで SIer での受託開発と、自社サービスの開発の両方を経験し、  
既存サービスの改善から新規立ち上げまで幅広いフェーズに携わってきました。

特に新規開発では、UI/UX 設計から API 連携、運用を見据えた構成設計まで一貫して対応し、  
プロジェクトごとに適切な最適解を選択しながら進めることを強みとしています。

また、社内勉強会の企画・登壇を担当するなど、  
技術面だけでなくチーム全体へのナレッジ共有にも積極的に取り組んできました。

今後は、技術領域にとらわれず必要な知識を素早くキャッチアップし、  
「上流から逆算してプロダクト価値を最大化できるエンジニア」 として  
企画・要件定義・設計を含めたより包括的な役割に挑戦していきます。

---

# 主な業務経歴

以下に、過去に携わらせていただいたプロジェクトに関する概要と詳細を"最新順に"記載していきます。

<details>
  <summary>Next.js App Router を使用した野球スコア入力アプリのリプレイス開発</summary>
...
フロントエンドは「Next.js+Vercel」で、バックエンドは「DRF (Python) + Fly.io」で野球スコア入力アプリのリプレイスを実施しました。エンジニアのテックリードとして4名のチームで開発を行いました。リリース前の段階で先にUIだけのモックアプリを作成し、そのアプリで営業チームにテストユーザーを獲得してもらいながら開発を進めていき、本リリースから2ヶ月で損益分岐点を突破することに成功しました。

</details>

<details>
  <summary>Next.js App Router を使用した 釣船予約サイト の新規開発</summary>
...
<details>
  <summary>React Native を使用した「釣りアプリ」の保守・運用</summary>
...
<details>
  <summary>React Native を使用したマッチングアプリのクロスプラットフォーム（iOS / Android）開発</summary>

## プロジェクト期間

2022年10月 〜 2025年3月31日まで
...
<details>
  <summary>アダルト用のサブスクリプション動画配信サービスの大規模新規開発</summary>
...
<details>
  <summary>サブスクリプション動画配信サービスの大規模新規開発</summary>
...
<details>
  <summary>スマホで履歴書を簡単に作成できるWebサービスの開発</summary>
...
<details>
  <summary>B to B 向けの人事管理をラクにする管理画面開発</summary>
...
<details>
  <summary>シェアードタレントネットワークのWebアプリケーションの新規開発</summary>
...
<details>
  <summary>ホテル予約サイトのコンポーネントリファクタリング業務・テストを導入することによる品質改善業務</summary>
...
<details>
  <summary>共通コンポーネントのnpmパッケージ化・新規開発</summary>
...
<details>
  <summary>ホテル予約サイトのバグ回収業務・新機能の実装・パフォーマンス改善業務</summary>
...
<details>
  <summary>動画面接サービスの管理画面の新規開発</summary>
...
<details>
  <summary>ECサイトの既存機能の追加・改修業務</summary>
